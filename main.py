...
if __name__ == "__main__":
  ...
  """
    if len(sys.argv) == 2:
        ...
        parser.add_argument("--model", type=str, default="openai/gpt-4o-mini", help="model to use. For OpenRouter use 'openai/gpt-4o-mini', 'openai/gpt-3.5-turbo', etc. For OpenAI use 'gpt-4-0613', 'gpt-3.5-turbo-0613'")
